...
public class Engineer extends Kit {
    ...
    public void turret(Location l) {
        ...
        s1.addPotionEffect(new PotionEffect(PotionEffectType.SLOWNESS, 99999999, 3));
        s1.setDerp(true);
    }

    public void overload() {
        BukkitTask overloadTask = new BukkitRunnable() {
    ...
    public class SnowmanTurret extends SnowGolem {
        ...
        protected void registerGoals() {
            ...
            this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>((Mob)this, net.minecraft.world.entity.player.Player.class, 10, true, false, (TargetingConditions.Selector) null));
        ...
        public void performRangedAttack(LivingEntity entityliving, float f) {
            ...
            entitysnowball.setOwner((LivingEntity)this);
