...
public class Lumberjack extends Kit {
    ...
    private class mysticSapProcess extends BukkitRunnable {
        ...
        public void createGreenParticles() {
            Objects.requireNonNull(loc.getWorld()).spawnParticle(Particle.HAPPY_VILLAGER, loc, 5,0.0,0.0,0.0,0.0);
        }
        ...
        public void createHeadParticles() {
            ...
            Objects.requireNonNull(loc.getWorld()).spawnParticle(Particle.DUST, locAdd, 1, teamDust);
        }
